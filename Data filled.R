...
d2 = as.POSIXct("2019-09-01 00:00:00", tz = "UTC")
all = data.frame(Date = seq(d1 , d2, by = "hour"))
#all = data.frame(Date = seq(as.POSIXct("2014-01-01 00:00:00") , as.POSIXct("2019-09-01 23:00:00"), by = "hour"))
...
temp=temp[,c('date','Means')]
sum(is.na(temp))
temp[is.na(temp$Means),]
